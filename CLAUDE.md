...
This is the user's home directory, not a traditional code repo. The primary systems here are dotfiles management, workspace orchestration, and Obsidian integration.
