# Generated by Powerlevel10k configuration wizard on 2024-08-07 at 03:07 PDT.
...
# 12h time, angled separators, blurred heads, flat tails, 2 lines, solid, right frame,
...
() {
  ...
  # Green prompt symbol if the last command succeeded. 76
